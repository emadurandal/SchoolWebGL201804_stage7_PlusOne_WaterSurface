...
// Header -----------------------------------------------
  glTips.createCanvas = glTips_createCanvas; // glTips#createCanvas(id:string, resolutionWidth:number, resolutionHeight:number):HTMLCanvasElement
...
// Implementation ---------------------------------------
   ...
   * @param {number} resolutionWidth The canvas' resolution width.
   * @param {number} resolutionHeight The canvas' resolution height.
   * @return {HTMLCanvasElement} The created canvas.
   * @memberOf module:glTips
   */
  function glTips_createCanvas(id, resolutionWidth, resolutionHeight) {
   ...
   * @memberOf module:glTips
   */
  function glTips_setupTexture2D(gl, src, level, internalFormat, format, type,
    magFileter, minFilter, wrapS, wrapT, mipmap, flipY, callback) {
    
    let img = null;
    const createGlTexture = function() {
